...
urlpatterns = [
    ...
    path('association/<int:association_id>/leagues/', views.association_leagues, name='association_leagues'),
    path('league-schedule/<str:age_group>/<str:tier>/<str:season>/<int:association_id>/', 
